...
class Revisionca extends Model
{
    ...
    protected $fillable=['periodo','ruta', 'codigo','lecturaan','consumoan','lecturaac','consumoac','promedio','causadenol','nombre','estrato', 'direccion','nmedidor','estado','lecturar','observacion'];
    //protected $guarded = [];
